...
10. вторая нормальная форма (2нф)
...
11. третья нормальная форма (3нф)
...
12. нормальная форма бойса-кодда (бкнф)
...
20. табличные пользовательские функции (udf)
...
21. использование псевдонимов (aliases)
...
22. сохранение результата запроса в таблицу
...
23. изменение данных и объектов бд
...
26. скалярные пользовательские функции (udf)
...
27. фильтрация данных в запросах
...
28. команды для работы с данными в sql
